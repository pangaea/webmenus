...
public class RandomGUID extends Object {
    ...
    private void getRandomGUID(boolean secure) {
        ...
        try {
        	...
        	SystemServlet.g_logger.error("Error: " + e);
        }
    ...
    public static void main(String args[]) {
	    ...
	    SystemServlet.g_logger.debug("Seeding String=" + myGUID.valueBeforeMD5);
	    SystemServlet.g_logger.debug("rawGUID=" + myGUID.valueAfterMD5);
	    SystemServlet.g_logger.debug("RandomGUID=" + myGUID.toString());
        }
    }
}