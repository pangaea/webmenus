...
<%
	...
	while( input_number <= questcount )
	{
		...
		else if( _enum.equalsIgnoreCase( "muliple select" ) == true ) type = 2;
...
%>
				<!--tr>
					<td width="400" colspan="3"><div width="50%" class="list_heading">50%</div></td>
				</tr-->
				<tr><td valign="top" width="20">
				<%=display%>) </td><td width="180">
				<div DATAFORMATAS="HTML" align="left"><%=sb_body.getStr()%></div>
				</td><td valign="top" align="left"><%=percSel%>%</td><td width="300"><div style="width:<%=percSel%>%;" class="list_heading"></div></td><td valign="top" nowrap><%=selection%> votes</td></tr>
<%
				}
				i++;
			}
...
%>
				<tr><td colspan="5" align="right">
					<strong>Total:</strong>&nbsp;<%=totals%> votes
				</td></tr>
				</table>
<%
		}
...
<p>
	<center>
		...
		<a href="javascript:window.close();">
			<img border="0" src="../images/buttons/close.gif"/>
		</a>
	</center>
</p>
</CENTER>
