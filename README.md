...
- If running tomcat from catalina.sh
...
- If running tomcat using systemctl
~~~
cd /etc/systemd/system
vi tomcat9.service
# Adjust the file location and the GENESYS_HOME path as needed.
#Set variables in this file (eg):
Environment='GENESYS_HOME=/opt/tomcat/webapps/webmenus/'
Environment='GENESYS_S3_BUCKET=webmenus-development-us-standard'
~~~
